...
void keyboard( unsigned char key, int x, int y )
{
	...
	case (GLFW_KEY_1):
				shader.updatePicker(1); shader.startup();
	break;
	case (GLFW_KEY_2):
				shader.updatePicker(2); shader.startup();
	break;
	case (GLFW_KEY_3):
				shader.updatePicker(3); shader.startup();
	break;
	case (GLFW_KEY_4):
				shader.updatePicker(4); shader.startup();
	break;
	case (GLFW_KEY_5):
				shader.updatePicker(5); shader.startup();
	break;
	default:
		break;
	}
